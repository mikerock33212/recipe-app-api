...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_retrieve_ingredient_list(self):
        ...
        Ingredient.objects.create(user=self.user,name='KK')
        Ingredient.objects.create(user=self.user, name='SS')
    ...
    def test_ingredients_limited_to_user(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='TT')
